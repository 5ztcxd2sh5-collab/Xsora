...
‏                    if (heroTitleEl) {
‏                        heroTitleEl.innerHTML = (config.hero_title || defaultConfig.hero_title).replace(/\n/g, '<br>');
                    }

‏                    // Update CTA button
‏                    const ctaButtonEl = document.getElementById('ctaButtonText');
‏                    if (ctaButtonEl) {
‏                        ctaButtonEl.textContent = config.cta_button || defaultConfig.cta_button;
                    }

‏                    // Update designer name
‏                    const designerNameEl = document.getElementById('designerName');
‏                    if (designerNameEl) {
‏                        designerNameEl.textContent = config.designer_name || defaultConfig.designer_name;
                    }
                },
...
‏    </script>
‏ <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'99ed5a1bd02d0ea1',t:'MTc2MzE5NTA2My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})
